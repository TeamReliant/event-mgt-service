...
ENV NODE_ENV=production \
    ...
    STRIPE_REDIRECT_URI="https://plaventi.dev" \
    STRIPE_PRO_PRICE_ID=price_1PzIaLP4Gkbi4QVGJIZyh90i \
    STRIPE_PREMIUM_PRICE_ID=price_1PzIckP4Gkbi4QVG4arwRvz6 \
    STRIPE_SUBSCRIPTION_SUCCESS_URI="https://plaventi.dev/subscription-result" \
    STRIPE_SUBSCRIPTION_CANCEL_URI="https://plaventi.dev/organizer" \
    FRONTEND_URL="https://plaventi.dev" \
...
CMD ["npm", "run", "start:prod", "--no-sandbox", "--disable-setuid-sandbox"]
